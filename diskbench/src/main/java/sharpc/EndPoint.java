...
import static sharpc.EndPoint.State.BODY;
import static sharpc.EndPoint.State.HEADER;
...
public abstract class EndPoint {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Thread.currentThread().setName("sharpc-server-thread");
        ...
        Thread.currentThread().setName("sharpc-client-thread");
        t.start();
        ...
        while(true) {
            ...
            int finalI = i;
            client.send(-1, data, new CompletionHandler<byte[], Void>() {
...
//            }
    ...
    static class Client extends EndPoint {

        public Client(SocketChannel socketChannel) throws IOException, InterruptedException {
            super(socketChannel);
        }
...
//            log.info("firing callback for {}", id);
    ...
    static class Server extends EndPoint {
        public Server(SocketChannel socketChannel) throws IOException, InterruptedException {
            super(socketChannel);
        }
